...
def calc_forecast_summary(
    ...
    """Выполняет комплексный анализ точности прогнозов футбольных матчей, сравнивая предсказанные результаты матчей с фактическими.

     Предоставляет комплексную статистику, позволяющую анализировать эффективность алгоритмов прогнозирования с разных сторон - от точного счета
     до общих тенденций по тоталам и исходам. Это помогает понять сильные и слабые стороны системы прогнозирования и оптимизировать её параметры.
