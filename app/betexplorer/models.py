...
class Sport(Base):
    ...
    sport_name: Mapped[str] = mapped_column(
        String(255),
        nullable=False,
        comment='Название вида спорта',
    )
    sport_url: Mapped[str] = mapped_column(
        String(255),
        nullable=False,
...
class CountrySport(Base):
    ...
    country_order: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
        comment='Номер по порядку вывода страны',
    )
...
class Championship(Base):
    ...
    championship_order: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
        comment='Номер по порядку вывода чемпионата',
    )
    championship_years: Mapped[str] = mapped_column(
        String(255),
        nullable=False,
        comment='Годы проведения',
    )
...
class Team(Base):
    ...
    team_full: Mapped[str | None] = mapped_column(
        String(255),
        nullable=True,
        comment='Название команды (полное)',
    )
    team_url: Mapped[str | None] = mapped_column(
        String(255),
        nullable=True,
        comment='Ссылка на страницу команды',
    )
    team_emblem: Mapped[str | None] = mapped_column(
        String(255),
        nullable=True,
...
class Match(Base):
    ...
    match_url: Mapped[str] = mapped_column(
        String(255),
        nullable=False,
        comment='Ссылка на матч',
    )
    ...
    home_team_emblem: Mapped[str | None] = mapped_column(
        String(255),
        nullable=True,
        comment='Ссылка на эмблему команды',
    )
    ...
    away_team_emblem: Mapped[str | None] = mapped_column(
        String(255),
        nullable=True,
        comment='Ссылка на эмблему команды',
    )
    ...
    score_stage: Mapped[str | None] = mapped_column(
        String(255),
        nullable=True,
        comment='Примечания к результату матча (победа по пенальти, игра прервалась и прочие)',
    )
    score_stage_short: Mapped[str | None] = mapped_column(
        String(255),
        nullable=True,
        comment='Примечание к результату в кратком виде',
    )
    is_fixture: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
    ...
    stage_name: Mapped[str | None] = mapped_column(
        String(255),
        nullable=True,
        comment='Стадия чемпионата (квалификация, групповой этап и прочие)',
    )
...
class TimeScore(Base):
    ...
    half_number: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
        comment='Номер тайма',
    )
...
class Shooter(Base):
    ...
    home_away: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
    ...
    overtime: Mapped[str | None] = mapped_column(
        String(255),
        nullable=True,
        comment='Дополнительное время',
    )
    player_name: Mapped[str | None] = mapped_column(
        String(255),
        nullable=True,
        comment='Фамилия игрока',
    )
    penalty_kick: Mapped[str | None] = mapped_column(
        String(255),
        nullable=True,
        comment='Гол забит с пенальти',
    )
    event_order: Mapped[int | None] = mapped_column(
        Integer,
        nullable=True,
...
class ChampionshipStage(Base):
    ...
    stage_url: Mapped[str] = mapped_column(
        String(255),
        nullable=False,
    ...
    stage_current: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
        comment='Текущая стадия',
    )
