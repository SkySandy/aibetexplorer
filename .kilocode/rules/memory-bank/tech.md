...
- **Максимальная длина строки**: 119 символов для всего исходного кода
  - Все строки исходного кода должны быть ограничены лимитом в 119 символов
  - Строки, превышающие этот лимит, должны быть разбиты на несколько строк
  - Исключение: строки с комментарием `# noqa: E501` не модифицируются
